...
#include "LearningToRacePlayerController.generated.h"

class UInputMappingContext;
class ALearningToRacePawn;
class ULearningToRaceUI;
 ...
 */
UCLASS(abstract)
class LEARNINGTORACE_API ALearningToRacePlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<ALearningToRacePawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<ULearningToRaceUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<ULearningToRaceUI> VehicleUI;
