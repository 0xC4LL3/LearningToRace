...
ALearningToRaceOffroadCar::ALearningToRaceOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = ULearningToRaceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = ULearningToRaceOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = ULearningToRaceOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = ULearningToRaceOffroadWheelRear::StaticClass();
