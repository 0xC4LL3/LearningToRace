...
ALearningToRaceSportsCar::ALearningToRaceSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = ULearningToRaceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = ULearningToRaceSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = ULearningToRaceSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = ULearningToRaceSportsWheelRear::StaticClass();
